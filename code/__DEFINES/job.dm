...
//-------- BD MERCS --------//
#define JOB_MERCENARY_GRUNT "BD Grunt"
...
#define BD_MERCS_JOB_LIST list(JOB_MERCENARY_GRUNT, JOB_MERCENARY_PILOT, JOB_MERCENARY_SENTINEL, JOB_MERCENARY_SUPERVISOR, JOB_MERCENARY_BULWARK, JOB_MERCENARY_OFFICER)
