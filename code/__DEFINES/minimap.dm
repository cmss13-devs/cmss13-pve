...
#define MINIMAP_FLAG_IMPERIAL_GUARD (1<<6)
#define MINIMAP_FLAG_YAUTJA (1<<7)
#define MINIMAP_FLAG_XENO_CORRUPTED (1<<8)
#define MINIMAP_FLAG_XENO_ALPHA (1<<9)
#define MINIMAP_FLAG_XENO_BRAVO (1<<10)
#define MINIMAP_FLAG_XENO_CHARLIE (1<<11)
#define MINIMAP_FLAG_XENO_DELTA (1<<12)
#define MINIMAP_FLAG_XENO_FERAL (1<<13)
#define MINIMAP_FLAG_XENO_TAMED (1<<14)
#define MINIMAP_FLAG_XENO_MUTATED (1<<15)
#define MINIMAP_FLAG_XENO_FORSAKEN (1<<16)
#define MINIMAP_FLAG_XENO_RENEGADE (1<<17)
