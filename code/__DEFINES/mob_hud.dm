...
#define MOB_HUD_FACTION_IASF 16
#define MOB_HUD_FACTION_CLF 17
#define MOB_HUD_FACTION_PMC 18
#define MOB_HUD_FACTION_MARSHAL 19
#define MOB_HUD_FACTION_UACG 20
