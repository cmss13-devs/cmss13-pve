...
GLOBAL_LIST_INIT(ROLES_PMCPLT_SMALL, list(JOB_PMCPLAT_SMALL_LEADER, JOB_PMCPLAT_SMALL_FTL, JOB_PMCPLAT_SMALL_SG, JOB_PMCPLAT_SMALL_STANDARD, JOB_PMCPLAT_SMALL_MEDIC, JOB_PMCPLAT_SMALL_ENGI))
