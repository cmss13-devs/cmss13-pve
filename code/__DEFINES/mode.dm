...
var/global/list/ROLES_SQUAD_ALL = list(SQUAD_MARINE_1, SQUAD_MARINE_2, SQUAD_MARINE_3, SQUAD_MARINE_4, SQUAD_MARINE_5, SQUAD_MARINE_CRYO, SQUAD_MARINE_INTEL, SQUAD_UPP, SQUAD_LRRP, SQUAD_RAIDER)
...
var/global/list/ROLES_AI_RAIDER = list(JOB_SQUAD_LEADER_RAIDER, JOB_SQUAD_MEDIC_RAIDER, JOB_SQUAD_TEAM_LEADER_RAIDER, JOB_SQUAD_MARINE_RAIDER)
