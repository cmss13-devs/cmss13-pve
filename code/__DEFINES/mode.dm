...
GLOBAL_LIST_INIT(ROLES_AI_GROM, list(JOB_SQUAD_LEADER_GROM, JOB_SQUAD_TEAM_LEADER_GROM, JOB_SQUAD_MEDIC_GROM, JOB_SQUAD_SMARTGUN_GROM, JOB_SQUAD_MARINE_GROM, JOB_SQUAD_RTO_GROM))
