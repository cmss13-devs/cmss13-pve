...
GLOBAL_LIST_INIT(ROLES_BLACKSTONE, list(JOB_USCM_GROUND_CO, JOB_USCM_GROUND_AO, JOB_USCM_GROUND_SYNTH, JOB_USCM_GROUND_SQUAD_LEADER, JOB_USCM_GROUND_SQUAD_TEAM_LEADER, JOB_USCM_GROUND_SQUAD_MEDIC, JOB_USCM_GROUND_SQUAD_ENGI, JOB_USCM_GROUND_SQUAD_SPECIALIST, JOB_USCM_GROUND_SQUAD_SMARTGUNNER, JOB_USCM_GROUND_SQUAD_MARINE, JOB_USCM_GROUND_CIVILIAN))
