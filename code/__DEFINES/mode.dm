...
GLOBAL_LIST_INIT(ROLES_UACG, list(JOB_UACG_OFFICER, JOB_UACG_MESS, JOB_UACG_DOCTOR, JOB_UACG_CHAPLAIN, JOB_UACG_ARMORY, JOB_UACG_ARMORY_LACKEY, JOB_UACG_LEAD_MED, JOB_UACG_MEDIC_TRIAGE, JOB_UACG_LEAD_FIRE, JOB_UACG_MORTAR, JOB_UACG_SCR_GNR, JOB_UACG_SCR_RIFLE, JOB_UACG_SENLEAD, JOB_UACG_LEAD, JOB_UACG_MEDIC, JOB_UACG_TECH, JOB_UACG_DM, JOB_UACG_GNR, JOB_UACG_RIFLE))
