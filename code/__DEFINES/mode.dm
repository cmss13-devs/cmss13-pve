...
//Updated the lists, so TWE and CMB are more compatible with the USCM.
...
#define FACTION_LIST_MARINE_WY list(FACTION_MARINE, FACTION_USCM_GROUND, FACTION_PMC, FACTION_WY_DEATHSQUAD, FACTION_WY)
#define FACTION_LIST_MARINE_UPP list(FACTION_MARINE, FACTION_USCM_GROUND, FACTION_UPP)
#define FACTION_LIST_MARINE_TWE list(FACTION_MARINE, FACTION_USCM_GROUND, FACTION_TWE)
