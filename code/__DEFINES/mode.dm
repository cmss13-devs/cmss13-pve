...
GLOBAL_LIST_INIT(ROLES_SQUAD_ALL, list(SQUAD_MARINE_1, SQUAD_MARINE_2, SQUAD_MARINE_3, SQUAD_MARINE_4, SQUAD_MARINE_5, SQUAD_MARINE_CRYO, SQUAD_MARINE_INTEL, SQUAD_UPP, SQUAD_LRRP, SQUAD_PMCPLT, SQUAD_TWE))
...
GLOBAL_LIST_INIT(ROLES_RMCTROOP, list(JOB_RMCTROOP_LIEUTENANT, JOB_RMCTROOP_TROOPLEADER, JOB_RMCTROOP_SECTIONLEADER, JOB_RMCTROOP_TEAMLEADER, JOB_RMCTROOP_BREACHER, JOB_RMCTROOP_SMARTGUNNER, JOB_RMCTROOP_MARKSMAN, JOB_RMCTROOP_ENGI, JOB_RMCTROOP_MEDIC, JOB_RMCTROOP_RIFLEMAN))
