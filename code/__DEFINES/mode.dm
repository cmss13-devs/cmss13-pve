...
var/global/list/ROLES_SQUAD_USCM_GROUND = list(SQUAD_USCM_GROUND_1, SQUAD_USCM_GROUND_2) ///Referenced in marines_consoles.dm for crew tracking individual squads+members in the Remote Outpost mode.
...
var/global/list/ROLES_USCM = ROLES_CIC + ROLES_POLICE + ROLES_AUXIL_SUPPORT + ROLES_MISC + ROLES_ENGINEERING + ROLES_REQUISITION + ROLES_MEDICAL + ROLES_MARINES - ROLES_WO - ROLES_USCM_GROUND
var/global/list/ROLES_USCM_GROUND = list(JOB_USCM_GROUND_CO, JOB_USCM_GROUND_AO, JOB_USCM_GROUND_SYNTH, JOB_USCM_GROUND_SQUAD_LEADER, JOB_USCM_GROUND_SQUAD_TEAM_LEADER, JOB_USCM_GROUND_SQUAD_MEDIC, JOB_USCM_GROUND_SQUAD_SPECIALIST, JOB_USCM_GROUND_SQUAD_SMARTGUNNER, JOB_USCM_GROUND_SQUAD_MARINE, JOB_USCM_GROUND_CIVILIAN)
...
//All of the factions that use the marine hud icons procs instead of their own.
#define FACTION_LIST_MARINE_HUD list(FACTION_MARINE, FACTION_USCM_GROUND, FACTION_MARSHAL)

/// Faction families are there for switch() statements and ease of reference in case more sub-factions are added.
/// "FAMILY" is used to make a distinction from "group", so as not to confuse with mob.faction_group, which is a mutable list.
#define FACTION_FAMILY_MARINE FACTION_MARINE, FACTION_USCM_GROUND
#define FACTION_FAMILY_WY FACTION_PMC, FACTION_WY_DEATHSQUAD, FACTION_WY
#define FACTION_FAMILY_UPP FACTION_UPP
#define FACTION_FAMILY_CLF FACTION_CLF
#define FACTION_FAMILY_TWE FACTION_TWE

#define FACTION_LIST_MARINE list(FACTION_FAMILY_MARINE)
#define FACTION_LIST_WY list(FACTION_FAMILY_WY)
#define FACTION_LIST_TWE list(FACTION_FAMILY_TWE)

#define FACTION_LIST_MARSHAL list(FACTION_MARSHAL, FACTION_FAMILY_MARINE)
#define FACTION_LIST_MARINE_WY list(FACTION_FAMILY_MARINE, FACTION_FAMILY_WY)
#define FACTION_LIST_MARINE_UPP list(FACTION_FAMILY_MARINE, FACTION_FAMILY_UPP)
#define FACTION_LIST_MARINE_TWE list(FACTION_FAMILY_MARINE, FACTION_FAMILY_TWE)

#define FACTION_LIST_HUMANOID list(FACTION_FAMILY_MARINE, FACTION_FAMILY_WY, FACTION_FAMILY_UPP, FACTION_FAMILY_CLF, FACTION_FAMILY_TWE, FACTION_CONTRACTOR, FACTION_MARSHAL, FACTION_FREELANCER, FACTION_SURVIVOR, FACTION_NEUTRAL, FACTION_COLONIST, FACTION_MERCENARY, FACTION_DUTCH, FACTION_HEFA, FACTION_GLADIATOR, FACTION_PIRATE, FACTION_PIZZA, FACTION_SOUTO, FACTION_YAUTJA, FACTION_ZOMBIE)
