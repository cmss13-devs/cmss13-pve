...
GLOBAL_LIST_INIT(ROLES_AI_SUPPORT, list(JOB_SQUAD_LEADER, JOB_SQUAD_MEDIC, JOB_SQUAD_TEAM_LEADER, JOB_SQUAD_ENGI, JOB_SQUAD_MARINE))
...
GLOBAL_LIST_INIT(ROLES_AI_GUARD, list(JOB_SQUAD_LEADER_GUARD, JOB_SQUAD_MEDIC_GUARD, JOB_SQUAD_TEAM_LEADER_GUARD, JOB_SQUAD_SMARTGUN_GUARD, JOB_SQUAD_MARINE_GUARD))
...
#define FACTION_ECOTERROR "Green Banner Movement"
...
#define FACTION_WJ "Working Joes"
#define FACTION_REVANCHISTS "Revanchists"

#define FACTION_LIST_HUMANOID list(FACTION_MARINE, FACTION_PMC, FACTION_WY, FACTION_WY_DEATHSQUAD, FACTION_CLF, FACTION_CONTRACTOR, FACTION_MARSHAL, FACTION_UPP, FACTION_FREELANCER, FACTION_SURVIVOR, FACTION_NEUTRAL, FACTION_COLONIST, FACTION_MERCENARY, FACTION_DUTCH, FACTION_HEFA, FACTION_GLADIATOR, FACTION_PIRATE, FACTION_PIZZA, FACTION_SOUTO, FACTION_YAUTJA, FACTION_ZOMBIE, FACTION_TWE, FACTION_ARMY, FACTION_NAVY, FACTION_CANC, FACTION_UA_REBEL, FACTION_TWE_REBEL, FACTION_ECOTERROR, FACTION_REVANCHISTS)
