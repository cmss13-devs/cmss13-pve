...
var/global/list/ROLES_AI_WO = list(JOB_WO_AI_CO, JOB_WO_AI_MO, JOB_WO_AI_SYNTH, JOB_WO_AI_SQUAD_LEADER, JOB_WO_AI_SQUAD_TEAM_LEADER, JOB_WO_AI_SQUAD_MEDIC, JOB_WO_AI_SQUAD_SPECIALIST, JOB_WO_AI_SQUAD_SMARTGUNNER, JOB_WO_AI_SQUAD_MARINE, JOB_WO_AI_CIVILIAN)
...
#define BLURB_USCM_COMBAT JOB_CO, JOB_XO, JOB_SO, JOB_WO_CO, JOB_WO_XO, JOB_WO_CHIEF_POLICE, JOB_WO_SO, JOB_WO_CREWMAN, JOB_WO_POLICE, JOB_SEA,\
						...
						JOB_WO_AI_CO, JOB_WO_AI_SQUAD_LEADER, JOB_WO_AI_SQUAD_TEAM_LEADER, JOB_WO_AI_SQUAD_MEDIC, JOB_WO_AI_SQUAD_SPECIALIST, JOB_WO_AI_SQUAD_SMARTGUNNER, JOB_WO_AI_SQUAD_MARINE
...
#define BLURB_USCM_MEDICAL JOB_CMO, JOB_RESEARCHER, JOB_DOCTOR, JOB_NURSE, JOB_WO_CMO, JOB_WO_RESEARCHER, JOB_WO_DOCTOR, JOB_WO_AI_MO
...
#define FACTION_MARINE_GROUND "USCM Outpost" //Specific to ground operations, mostly so that landlines work correctly in WO.
...
#define FACTION_LIST_MARINE_WY list(FACTION_MARINE, FACTION_MARINE_GROUND, FACTION_PMC, FACTION_WY_DEATHSQUAD, FACTION_WY)
#define FACTION_LIST_MARINE_UPP list(FACTION_MARINE, FACTION_MARINE_GROUND, FACTION_UPP)
#define FACTION_LIST_MARINE_TWE list(FACTION_MARINE, FACTION_MARINE_GROUND, FACTION_TWE)
