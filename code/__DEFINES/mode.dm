...
GLOBAL_LIST_INIT(ROLES_SQUAD_ALL, list(SQUAD_MARINE_1, SQUAD_MARINE_2, SQUAD_MARINE_3, SQUAD_MARINE_4, SQUAD_MARINE_5, SQUAD_MARINE_CRYO, SQUAD_MARINE_INTEL, SQUAD_UPP, SQUAD_LRRP, SQUAD_PMCPLT, SQUAD_PMCPLT_SMALL, SQUAD_RMC, SQUAD_IMPPLT, SQUAD_IMPPLT_2))
...
GLOBAL_LIST_INIT(ROLES_IMPPLT, list(JOB_IMPPLAT_LEADER, JOB_IMPPLAT_FTL, JOB_IMPPLAT_SPECIALIST, JOB_IMPPLAT_VOX, JOB_IMPPLAT_STANDARD, JOB_IMPPLAT_MEDICAE))
...
#define FACTION_IMPERIAL_GUARD "Imperial Guard"
#define FACTION_KASRKIN "Kasrkin"
#define FACTION_TRAITOR "Traitor Forces"

#define FACTION_LIST_UA list(FACTION_MARINE, FACTION_ARMY, FACTION_NAVY)
#define FACTION_LIST_HUMANOID list(FACTION_MARINE, FACTION_PMC, FACTION_WY, FACTION_WY_DEATHSQUAD, FACTION_CLF, FACTION_CONTRACTOR, FACTION_MARSHAL, FACTION_UPP, FACTION_FREELANCER, FACTION_SURVIVOR, FACTION_NEUTRAL, FACTION_COLONIST, FACTION_MERCENARY, FACTION_DUTCH, FACTION_HEFA, FACTION_GLADIATOR, FACTION_PIRATE, FACTION_PIZZA, FACTION_SOUTO, FACTION_YAUTJA, FACTION_ZOMBIE, FACTION_TWE, FACTION_ARMY, FACTION_NAVY, FACTION_CANC, FACTION_UA_REBEL, FACTION_TWE_REBEL, FACTION_IMPERIAL_GUARD, FACTION_KASRKIN, FACTION_TRAITOR)
...
#define FACTION_LIST_IMPERIUM list(FACTION_IMPERIAL_GUARD, FACTION_KASRKIN)
