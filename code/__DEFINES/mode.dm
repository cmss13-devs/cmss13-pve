...
GLOBAL_LIST_INIT(ROLES_SQUAD_ALL, list(SQUAD_MARINE_1, SQUAD_MARINE_2, SQUAD_MARINE_3, SQUAD_MARINE_4, SQUAD_MARINE_5, SQUAD_MARINE_CRYO, SQUAD_MARINE_INTEL, SQUAD_UPP, SQUAD_LRRP, SQUAD_PMCPLT, SQUAD_PMCPLT_SMALL, SQUAD_RMC, SQUAD_ARMOUR, SQUAD_ARMOUR_UPP))
...
GLOBAL_LIST_INIT(ROLES_ARMOUR, list(JOB_SQUAD_ARMOUR_COMMANDER, JOB_SQUAD_ARMOUR_LEADER, JOB_SQUAD_ARMOUR_GUNNER, JOB_SQUAD_ARMOUR_DRIVER))
GLOBAL_LIST_INIT(ROLES_ARMOUR_UPP, list(JOB_SQUAD_ARMOUR_COMMANDER_UPP, JOB_SQUAD_ARMOUR_LEADER_UPP, JOB_SQUAD_ARMOUR_GUNNER_UPP, JOB_SQUAD_ARMOUR_DRIVER_UPP))
