...
/// These flags are normally set for a barricade.
#define PASS_BARRICADE_FRONT (PASS_HIGH_OVER_ONLY)
#define PASS_BARRICADE_BEHIND (PASS_OVER_THROW_ITEM|PASS_OVER_FIRE|PASS_HIGH_OVER_ONLY)
/// These are temporary flags that can get toggled. When not wired, they are added to the above group.
#define PASS_BARRICADE_FRONT_NOT_WIRED (PASS_OVER_THROW_ITEM|PASS_OVER_THROW_MOB)
#define PASS_BARRICADE_BEHIND_NOT_WIRED (PASS_OVER_THROW_MOB)
