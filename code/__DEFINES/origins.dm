...
#define UPP_ORIGINS list(ORIGIN_UPP, ORIGIN_UPP_CRADLE, ORIGIN_UPP_FRONTIERSMAN, ORIGIN_UPP_VOLUNTEER)

#define FACTION_ORIGINS list(ORIGIN_USCM, ORIGIN_USCM_LUNA, ORIGIN_USCM_OTHER, ORIGIN_USCM_COLONY, ORIGIN_USCM_FOREIGN, ORIGIN_USCM_AW, ORIGIN_USCM_CONVICT_MINOR, ORIGIN_USCM_CONVICT_GANG, ORIGIN_USCM_CONVICT_SMUGGLING, ORIGIN_UPP, ORIGIN_UPP_CRADLE, ORIGIN_UPP_FRONTIERSMAN, ORIGIN_UPP_VOLUNTEER)
