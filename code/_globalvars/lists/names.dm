...
GLOBAL_LIST_INIT(first_names_male_german, list("Wolfgang", "Klaus", "Hans", "Karl", "Adolf", "Helmut", "Georg", "Martin", "Ernst", "Peter", "Felix", "Albert", "Ludwig", "Johann","Bauer", "Klaas", "Klaus", "Adler", "Emil"))
