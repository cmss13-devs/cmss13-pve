...
GLOBAL_LIST_INIT(first_names_female_brazilian, list("Maria", "Ana", "Francisca", "Antônia", "Adriana", "Juliana", "Márcia", "Fernanda", "Patricia", "Aline", "Sandra", "Camila", "Amanda", "Jéssica", "Letícia", "Júlia", "Mariana", "Gabriela", "Beatriz", "Sônia", "Simone", "Rosângela", "Marlene", "Terezinha", "Ângela", "Isabel", "Maitê", "Antonela", "Maia", "Yasmin", "Tainá", "Aurora","Isis"))
