...
GLOBAL_LIST_INIT(radiochannels, list(
	...
	RADIO_CHANNEL_ARMOUR = ARMOUR_FREQ,
	...
	SQUAD_ARMOUR = ARMOUR_FREQ,
	SQUAD_ARMOUR_UPP = UPP_ARMOUR_FREQ,
	...
	RADIO_CHANNEL_UPP_ARMOUR = UPP_ARMOUR_FREQ,
...
// UPP Frequencies
#define UPP_FREQS list(UPP_FREQ, UPP_CMD_FREQ, UPP_ENGI_FREQ, UPP_MED_FREQ, UPP_CCT_FREQ, UPP_KDO_FREQ, UPP_GRD_FREQ, UPP_ARMOUR_FREQ)
...
#define DEPT_FREQS list(COMM_FREQ, MED_FREQ, ENG_FREQ, SEC_FREQ, SENTRY_FREQ, ALPHA_FREQ, BRAVO_FREQ, CHARLIE_FREQ, DELTA_FREQ, ECHO_FREQ, CRYO_FREQ, REQ_FREQ, JTAC_FREQ, INTEL_FREQ, WY_FREQ, ASF_FREQ, ARM_FREQ, ARMOUR_FREQ)
...
SUBSYSTEM_DEF(radio)
	...
	var/static/list/freq_to_span = list(
		...
		"[UPP_ARMOUR_FREQ]" = "upparmourradio",
		"[CLF_FREQ]" = "clfradio",
