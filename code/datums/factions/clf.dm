...
/datum/faction/clf/get_antag_guns_snowflake_equipment()
	return list(
		...
		list("MAC-15 Magazine (9x19mm)", 5, /obj/item/ammo_magazine/smg/mac15, null, VENDOR_ITEM_REGULAR),
		...
		list("MP5 Magazine (9x19mm)", 5, /obj/item/ammo_magazine/smg/mp5, null, VENDOR_ITEM_REGULAR),
		...
		list("VP70 Magazine (9x19mm)", 5, /obj/item/ammo_magazine/pistol/vp70, null, VENDOR_ITEM_REGULAR),
		list("Beretta 92FS Magazine (9x19mm)", 5, /obj/item/ammo_magazine/pistol/b92fs, null, VENDOR_ITEM_REGULAR),
...
/datum/faction/clf/get_antag_guns_sorted_equipment()
	return list(
		...
		list("MAC-15 Magazine (9x19mm)", 60, /obj/item/ammo_magazine/smg/mac15, VENDOR_ITEM_REGULAR),
		...
		list("MP5 Magazine (9x19mm)", 60, /obj/item/ammo_magazine/smg/mp5, VENDOR_ITEM_REGULAR),
		...
		list("VP70 Magazine (9x19mm)", 40, /obj/item/ammo_magazine/pistol/vp70, VENDOR_ITEM_REGULAR),
		list("Beretta 92FS Magazine (9x19mm)", 40, /obj/item/ammo_magazine/pistol/b92fs, VENDOR_ITEM_REGULAR),
