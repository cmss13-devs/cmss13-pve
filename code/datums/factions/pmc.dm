...
/datum/faction/pmc/get_antag_guns_snowflake_equipment()
	return list(
		...
		list("VP70 Magazine (9mm)", 5, /obj/item/ammo_magazine/pistol/vp70/normalpoint, null, VENDOR_ITEM_REGULAR),
...
/datum/faction/pmc/get_antag_guns_sorted_equipment()
	return list(
		...
		list("VP70 Magazine (9mm)", 50, /obj/item/ammo_magazine/pistol/vp70/normalpoint, null, VENDOR_ITEM_REGULAR),
