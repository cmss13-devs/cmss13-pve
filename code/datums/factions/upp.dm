...
/datum/faction/upp/get_antag_guns_snowflake_equipment()
	return list(
		...
		list("Type 71 AP Magazine (11.7x22mm)", 15, /obj/item/ammo_magazine/rifle/type71/ap, null, VENDOR_ITEM_REGULAR),
		list("Type 71 Magazine (11.7x22mm)", 5, /obj/item/ammo_magazine/rifle/type71, null, VENDOR_ITEM_REGULAR),
...
/datum/faction/upp/get_antag_guns_sorted_equipment()
	return list(
		...
		list("Type 71 AP Magazine (11.7x22mm)", 60, /obj/item/ammo_magazine/rifle/type71/ap, VENDOR_ITEM_REGULAR),
		list("Type 71 Magazine (11.7x22mm)", 60, /obj/item/ammo_magazine/rifle/type71, VENDOR_ITEM_REGULAR),
