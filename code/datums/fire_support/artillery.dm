/datum/fire_support/mortar
	...
	initiate_screen_message = list(
		"Coordinates confirmed, high explosive inbound!",
		"Artillery brings dignity to what would otherwise be an ugly brawl. Rounds, over"
	)
...
/datum/fire_support/mortar/incendiary/do_impact(turf/target_turf)
	...
	playsound(target_turf, 'sound/weapons/gun_flamethrower2.ogg', 35)
