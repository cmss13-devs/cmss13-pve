/datum/weather_ss_map_holder/si391_sekhmet
...
/datum/weather_ss_map_holder/si391_sekhmet/should_affect_area(area/A)
	return !CEILING_IS_PROTECTED(A.ceiling, CEILING_GLASS)

/datum/weather_ss_map_holder/si391_sekhmet/should_start_event()
