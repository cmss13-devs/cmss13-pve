...
GLOBAL_LIST_INIT(personal_weapons_list, list("Ithaca 37 shotgun" = /obj/item/weapon/gun/shotgun/pump, "Sawn-off double barrel shotgun" = /obj/item/weapon/gun/shotgun/double/sawn,\
