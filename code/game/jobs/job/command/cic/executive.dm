...
/datum/job/command/executive/generate_entry_message(mob/living/carbon/human/H)
	...
	if(title == JOB_USCM_GROUND_AO)
		entry_message_body = "You are the right hand of the Commander, a lieutenant, and an officer tasked with supporting the marines in their duties. <br>You are also a highly-skilled medical professional.<br> While the Outpost Commander handles general logistics and mission control, you are in charge of supply lines, medical affairs, and day-to-day operations. <br>Tend to the needs of the men and women in the outpost, make sure they are healthy and able to perform their duties, and are supplied with the equipment they need.<br> The Outpost Commander may assign additional duties for you. You are second in command, should anything happen to the senior officer. <br>Civilian guests have to follow military regulations, but they are not military personnel. <br>Protect them."
	return ..()
