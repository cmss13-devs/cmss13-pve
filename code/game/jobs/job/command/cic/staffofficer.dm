...
/datum/job/command/bridge
	...
	gear_preset = /datum/equipment_preset/uscm/so
	gear_preset_secondary = /datum/equipment_preset/uscm/so/lesser_rank
...
/datum/job/command/bridge/ai/upp
	title = JOB_SO_UPP
	gear_preset = /datum/equipment_preset/uscm/so/upp
	gear_preset_secondary = /datum/equipment_preset/uscm/so/upp/lesser_rank
