...
/datum/job/command/bridge
	...
	gear_preset = /datum/equipment_preset/uscm/ship/so
	gear_preset_secondary = /datum/equipment_preset/uscm/ship/so/lesser_rank
...
/datum/job/command/bridge/ai/upp
	title = JOB_SO_UPP
	gear_preset = /datum/equipment_preset/uscm/ship/so/upp
	gear_preset_secondary = /datum/equipment_preset/uscm/ship/so/upp/lesser_rank
...
// todo: above	gear_preset_secondary = /datum/equipment_preset/uscm/ship/so/upp/lesser_rank

	gear_preset = /datum/equipment_preset/uscm/ship/so/pmc
	job_options = null
