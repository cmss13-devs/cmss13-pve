...
/obj/structure/machinery/cm_vending/sorted/cargo_guns/populate_product_list(scale)
	listed_products = list(
		...
		list("M74 AGM-F Grenade box", 0, /obj/item/storage/box/nade_box/m79_40mm/airburst, VENDOR_ITEM_REGULAR),
		list("M74 AGM-I Grenade Box", 0, /obj/item/storage/box/nade_box/m79_40mm/airburst/incen, VENDOR_ITEM_REGULAR),
		list("M74 AGM-S Smoke Grenade Box", 0, /obj/item/storage/box/nade_box/m79_40mm/airburst/smoke, VENDOR_ITEM_REGULAR),
