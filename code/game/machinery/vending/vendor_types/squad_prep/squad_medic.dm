...
GLOBAL_LIST_INIT(cm_vending_clothing_marsoc_medic, list(
		list("MEDICAL SET (MANDATORY)", 0, null, null, null),
		list("Essential Medical Set", 0, /obj/effect/essentials_set/medic, MARINE_CAN_BUY_ESSENTIALS, VENDOR_ITEM_MANDATORY),
		...
		list("ARMOR (CHOOSE 1)", 0, null, null, null),
		list("M3 SOF Armor", 0, /obj/item/clothing/suit/storage/marine/sof, MARINE_CAN_BUY_ARMOR, VENDOR_ITEM_RECOMMENDED),
		list("M3 SOF Armor (Padless)", 0, /obj/item/clothing/suit/storage/marine/sof/light, MARINE_CAN_BUY_ARMOR, VENDOR_ITEM_REGULAR),

		list("BACKPACK (CHOOSE 1)", 0, null, null, null),
		list("SOF Backpack", 0, /obj/item/storage/backpack/marine/marsoc, MARINE_CAN_BUY_BACKPACK, VENDOR_ITEM_MANDATORY),

		list("BELT (CHOOSE 1)", 0, null, null, null),
		list("M276 Tactical Ammo Load Rig", 0, /obj/item/storage/belt/marine/tactical, MARINE_CAN_BUY_BELT, VENDOR_ITEM_REGULAR),
		list("M276 Tactical Pistol Holster Rig", 0, /obj/item/storage/belt/gun/tactical, MARINE_CAN_BUY_BELT, VENDOR_ITEM_REGULAR),
		list("M276 Tactical Lifesaver Bag (Full)", 0, /obj/item/storage/belt/medical/lifesaver/marsoc/full, MARINE_CAN_BUY_BELT, VENDOR_ITEM_RECOMMENDED),
		list("M276 Tactical Medical Storage Rig (Full)", 0, /obj/item/storage/belt/medical/marsoc/full, MARINE_CAN_BUY_BELT, VENDOR_ITEM_RECOMMENDED),
		list("M276 Tactical M44 Holster Rig", 0, /obj/item/storage/belt/gun/m44/tactical, MARINE_CAN_BUY_BELT, VENDOR_ITEM_REGULAR),
		list("M276 Tactical M82F Holster Rig", 0, /obj/item/storage/belt/gun/flaregun, MARINE_CAN_BUY_BELT, VENDOR_ITEM_REGULAR),
		...
		list("First-Aid Pouch (Splints, Gauze, Ointment)", 0, /obj/item/storage/pouch/firstaid/full/alternate, MARINE_CAN_BUY_POUCH, VENDOR_ITEM_REGULAR),
		list("First-Aid Pouch (Pill Packets)", 0, /obj/item/storage/pouch/firstaid/full/pills, MARINE_CAN_BUY_POUCH, VENDOR_ITEM_REGULAR),
		list("Tactical Medical Pouch", 0, /obj/item/storage/pouch/medical/socmed, MARINE_CAN_BUY_POUCH, VENDOR_ITEM_REGULAR),
		list("Flare Pouch (Full)", 0, /obj/item/storage/pouch/flare/full, MARINE_CAN_BUY_POUCH, VENDOR_ITEM_REGULAR),
		list("Sling Pouch", 0, /obj/item/storage/pouch/sling, MARINE_CAN_BUY_POUCH, VENDOR_ITEM_REGULAR),
		list("Large Pistol Magazine Pouch", 0, /obj/item/storage/pouch/magazine/pistol/large, MARINE_CAN_BUY_POUCH, VENDOR_ITEM_REGULAR),
		list("Magazine Pouch", 0, /obj/item/storage/pouch/magazine, MARINE_CAN_BUY_POUCH, VENDOR_ITEM_REGULAR),
		...
		list("ACCESSORIES (CHOOSE 1)", 0, null, null, null),
		list("Surgical Drop Pouch", 0, /obj/item/clothing/accessory/storage/surg_vest/drop_black/equipped, MARINE_CAN_BUY_ACCESSORY, VENDOR_ITEM_REGULAR),
...
/obj/structure/machinery/cm_vending/clothing/medic/marsoc
	name = "\improper ColMarTech Special Reconnaisance Corpsman Medical Gear Rack"

/obj/structure/machinery/cm_vending/clothing/medic/marsoc/get_listed_products(mob/user)
	return GLOB.cm_vending_clothing_marsoc_medic
