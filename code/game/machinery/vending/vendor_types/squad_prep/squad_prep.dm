...
/obj/structure/machinery/cm_vending/sorted/uniform_supply/squad_prep/pmc/populate_product_list(scale)
	listed_products = list(
		...
		list("Tactical Webbing", 2, /obj/item/clothing/accessory/storage/webbing/m3/uppsmall/pmc, VENDOR_ITEM_REGULAR),
		list("Tactical Magazine Webbing", 2, /obj/item/clothing/accessory/storage/webbing/m3/uppmags/pmc, VENDOR_ITEM_REGULAR),
		list("Tactical Grenade Webbing", 2, /obj/item/clothing/accessory/storage/webbing/m3/m40/pmc, VENDOR_ITEM_REGULAR),
		...
		list("UA Technical Satchel", floor(scale * 15), /obj/item/storage/backpack/marine/satchel/tech, VENDOR_ITEM_REGULAR),
		list("UA Technician Backpack", floor(scale * 15), /obj/item/storage/backpack/marine/tech, VENDOR_ITEM_REGULAR),
		list("TWE Lightweight Rucksack", round(scale * 15), /obj/item/storage/backpack/rmc/light, VENDOR_ITEM_REGULAR),
		list("TWE Heavy-Duty Rucksack", round(scale * 15), /obj/item/storage/backpack/rmc/heavy, VENDOR_ITEM_REGULAR),
