...
/obj/structure/machinery/cm_vending/sorted/uniform_supply/squad_prep/imperial
	name = "\improper Imperial Guard Uniform Vendor"
	icon_state = "imperial_gear"
	req_access = list(ACCESS_MARINE_PREP)

/obj/structure/machinery/cm_vending/sorted/uniform_supply/squad_prep/imperial/populate_product_list(scale)
	listed_products = list(
		list("STANDARD EQUIPMENT", -1, null, null, null),
		list("Combat Boots", round(scale * 15), /obj/item/clothing/shoes/marine/civilian/knife, VENDOR_ITEM_REGULAR),
...
/obj/structure/machinery/cm_vending/sorted/cargo_guns/squad/imperial
	name = "\improper Imperial Guard Automated Utilities Squad Vendor"
	desc = "An automated supply rack hooked up to a small storage of various utilities and tools. Can be accessed by any Imperial Guardsman."
	req_access = list(ACCESS_MARINE_PREP)
	req_one_access = list()

/obj/structure/machinery/cm_vending/sorted/cargo_guns/squad/imperial/populate_product_list(scale)
	listed_products = list(
		list("FOOD", -1, null, null),
		list("MRE", floor(scale * 5), /obj/item/storage/box/mre, VENDOR_ITEM_REGULAR),
		list("MRE Box", floor(scale * 1), /obj/item/ammo_box/magazine/misc/mre, VENDOR_ITEM_REGULAR),
