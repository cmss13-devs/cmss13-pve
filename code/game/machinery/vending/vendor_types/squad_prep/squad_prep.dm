...
/obj/structure/machinery/cm_vending/sorted/cargo_guns/squad_prep/populate_product_list(scale)
	listed_products = list(
		...
		list("VP70 Magazine (9mm)", round(scale * 25), /obj/item/ammo_magazine/pistol/vp70/normalpoint, VENDOR_ITEM_REGULAR),
...
/obj/structure/machinery/cm_vending/sorted/cargo_guns/squad/populate_product_list(scale)
	listed_products = list(
		...
		list("SIDEARM AMMUNITION", -1, null, null),
		list("VP70 Magazine (9mm)", round(scale * 20), /obj/item/ammo_magazine/pistol/vp70/normalpoint, VENDOR_ITEM_REGULAR),
