...
/obj/item/storage/box/nade_box/update_icon()
	...
	if(opened)
		...
		return
	if(length(contents) >= 13)
		overlays += image(icon, "+[type_icon]_full")
	if(length(contents) <= 12)
...
/obj/item/storage/box/nade_box/foam
	...
	model_icon = "model_m42"
	type_icon = "foam"
	can_hold = list(/obj/item/explosive/grenade/metal_foam)
	grenade_type = /obj/item/explosive/grenade/metal_foam
...
/obj/item/storage/box/nade_box/m15
	...
	model_icon = "model_m15"
	type_icon = "m15"
	can_hold = list(/obj/item/explosive/grenade/high_explosive/m15)
	grenade_type = /obj/item/explosive/grenade/high_explosive/m15
...
/obj/item/storage/box/nade_box/training
	...
	icon_state = "training_nade_case"
	lid_icon = "training_nade_lid"
...
/obj/item/storage/box/nade_box/ltl/
	...
	lid_icon = "uscm_ltl_nade_lid"
	model_icon = "model_m230"
	type_icon = "ltl"
	can_hold = list(/obj/item/explosive/grenade/slug/baton)
	grenade_type = /obj/item/explosive/grenade/slug/baton
	has_gamemode_skin = FALSE

/obj/item/storage/box/nade_box/ltl/tear_gas
...
/obj/item/storage/box/nade_box/ltl/tear_gas/fill_preset_inventory()
	..()
	if(SSticker.mode && MODE_HAS_FLAG(MODE_FACTION_CLASH))
		handle_delete_clash_contents()
	else if(SSticker.current_state < GAME_STATE_PLAYING)
...
/obj/item/storage/box/nade_box/ltl/tear_gas/proc/handle_delete_clash_contents()
	if(MODE_HAS_FLAG(MODE_FACTION_CLASH))
		var/grenade_count = 0
...
/obj/item/storage/box/nade_box/ltl/sebb
	...
	model_icon = "model_sebb"
	type_icon = "sebb"
	can_hold = list(/obj/item/explosive/grenade/sebb)
	grenade_type = /obj/item/explosive/grenade/sebb

//40MM GRENADE BOXES------------------------//

/obj/item/storage/box/nade_box/m79_40mm
	name = "\improper 40mm HEDP grenade box"
	desc = "A secure box holding 25 40mm High-Explosive, Dual-Purpose grenades."
	icon_state = "uscm_40mm_nade_case"
	lid_icon = "uscm_40mm_nade_lid"
	model_icon = "uscm_model_40mm"
	type_icon = "hedp"
	grenade_type = /obj/item/explosive/grenade/high_explosive/impact
	can_hold = list(/obj/item/explosive/grenade/high_explosive/impact)

/obj/item/storage/box/nade_box/m79_40mm/update_icon()
	overlays.Cut()
	if(opened)
		overlays -= image(icon, "[lid_icon]")
	else
		...
		return
	if(length(contents) >= 13)
		overlays += image(icon, "+40mm_[type_icon]_full")
	if(length(contents) <= 12)
		overlays += image(icon, "+40mm_[type_icon]_half")

/obj/item/storage/box/nade_box/m79_40mm/frag
	name = "\improper 40mm HEFA grenade box"
	desc = "A secure box holding 25 40mm High-Explosive, Fragmenting-Antipersonnel grenades."
	type_icon = "hefa"
	grenade_type = /obj/item/explosive/grenade/high_explosive/impact/frag
	can_hold = list(/obj/item/explosive/grenade/high_explosive/impact/frag)

/obj/item/storage/box/nade_box/m79_40mm/incen
	name = "\improper 40mm incendiary grenade box"
	desc = "A secure box holding 25 40mm incendiary grenades."
	type_icon = "hiam"
	grenade_type = /obj/item/explosive/grenade/incendiary/impact
	can_hold = list(/obj/item/explosive/grenade/incendiary/impact)

/obj/item/storage/box/nade_box/m79_40mm/canister
	name = "\improper 40mm canister grenade box"
	desc = "A secure box holding 25 40mm canister grenades."
	type_icon = "buck"
...
/obj/item/storage/box/nade_box/m79_40mm/canister
	...
	lid_icon = "uscm_ltl_nade_lid"
	type_icon = "ltl"
	grenade_type = /obj/item/explosive/grenade/slug/baton/m79
	can_hold = list(/obj/item/explosive/grenade/slug/baton/m79)

//M74 GRENADE BOXES------------------------//

/obj/item/storage/box/nade_box/m79_40mm/airburst
...
/obj/item/storage/box/nade_box/m79_40mm/airburst/incen
...
/obj/item/storage/box/nade_box/m79_40mm/airburst/smoke
	...
	model_icon = "model_m74"
	type_icon = "agms"
	can_hold = list(/obj/item/explosive/grenade/smokebomb/airburst)
	grenade_type = /obj/item/explosive/grenade/smokebomb/airburst
