...
/obj/structure/prop/invuln/lore_computer/attack_hand(mob/user)
	...
	switch(pointer)
		...
		if(3)
			visible_message(SPAN_NOTICE("Current network <b>node</b> unique identifier: <b>CG-CMP-LS</b>."))
		if(4)
		...
		if(19 to 26)
			visible_message(SPAN_NOTICE("Encrypting received data from node  <b>WY-OR-STL</b>. Please wait."))
		if(27)
