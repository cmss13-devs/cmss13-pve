...
/proc/get_sfx(sound)
	if(istext(sound))
		switch(sound)
			...
			if("male_twe_warcry")
				sound = pick('sound/voice/twe_warcry/aussiemale1.ogg', 'sound/voice/twe_warcry/aussiemale2.ogg','sound/voice/twe_warcry/aussiemale3.ogg', 'sound/voice/twe_warcry/aussiemale4.ogg', 'sound/voice/twe_warcry/aussiemale5.ogg', 'sound/voice/twe_warcry/aussiemale6.ogg', 'sound/voice/twe_warcry/aussiemale7.ogg', 'sound/voice/twe_warcry/aussiemale8.ogg', 'sound/voice/twe_warcry/aussiemale9.ogg', 'sound/voice/twe_warcry/aussiemale10.ogg', 'sound/voice/twe_warcry/aussiemale11.ogg', 'sound/voice/twe_warcry/aussiemale12.ogg', 'sound/voice/twe_warcry/aussiemale13.ogg')
			if("female_scream")
			...
			if("female_twe_warcry")
				sound = pick('sound/voice/twe_warcry/aussiefemale1.ogg', 'sound/voice/twe_warcry/aussiefemale2.ogg', 'sound/voice/twe_warcry/aussiefemale3.ogg')
			if("rtb_handset")
