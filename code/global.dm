...
#define SHIP_MAP_NAMES list("USS Almayer", "USS Golden Arrow",  "USS Golden Arrow (Classic)", "SSV Chapaev", "USS Rover", "USS Golden Arrow Tethered", "LV818 Firebase Zulu", "LV818 Firebase Juliet","LV818 Firebase Juliet_forecon", "LV522_Firebase_Charlie_Charlie", "USCSS Firefly")
