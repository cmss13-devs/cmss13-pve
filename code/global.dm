...
#define SHIP_MAP_NAMES list("USS Almayer", "USS Golden Arrow",  "USS Golden Arrow (Classic)", "SSV Chapaev", "USS Rover", "USS Golden Arrow Teathered", "LV818 Firebase Zulu", "USCSS Firefly")
