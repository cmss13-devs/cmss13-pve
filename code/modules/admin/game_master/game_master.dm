...
// Spawn stuff
#define DEFAULT_SPAWN_XENO_STRING XENO_CASTE_BODYBURSTER
#define GAME_MASTER_AI_XENOS list(XENO_CASTE_LANKY, XENO_CASTE_BODYBURSTER, XENO_CASTE_DRONE, XENO_CASTE_SOLDIER, XENO_CASTE_RUNNER, RUNNER_ACIDER, XENO_CASTE_LURKER, XENO_CASTE_CRUSHER, XENO_CASTE_FACEHUGGER)
