...
#define GAME_MASTER_AI_XENOS list(XENO_CASTE_SPIDER_GUARD, XENO_CASTE_SPIDER_NURSE, XENO_CASTE_SPIDER_HUNTER, XENO_CASTE_DRONE, XENO_CASTE_SOLDIER, XENO_CASTE_RUNNER, RUNNER_ACIDER, XENO_CASTE_LURKER, XENO_CASTE_CRUSHER, XENO_CASTE_FACEHUGGER)
