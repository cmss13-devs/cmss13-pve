...
/datum/game_master/New(client/using_client)
	...
	game_master_phone.AddComponent(/datum/component/phone/virtual, "Game Master", "white", "Company Command", null, PHONE_DND_ON, list(FACTION_MARINE, FACTION_COLONIST, FACTION_WY, FACTION_IMPERIAL_GUARD), list(FACTION_MARINE, FACTION_COLONIST, FACTION_WY, FACTION_IMPERIAL_GUARD), null, using_client)
