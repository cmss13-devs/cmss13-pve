...
/datum/game_master/New(client/using_client)
	...
	game_master_phone.AddComponent(/datum/component/phone/virtual, "Game Master", "white", "Company Command", null, PHONE_DO_NOT_DISTURB_ON, list(FACTION_MARINE, FACTION_MARINE_GROUND, FACTION_COLONIST, FACTION_WY), list(FACTION_MARINE, FACTION_MARINE_GROUND, FACTION_COLONIST, FACTION_WY), null, using_client)
