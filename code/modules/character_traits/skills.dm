...
/datum/character_trait/skills/medical
	...
	trait_desc = "Boosts the medical skill to 1. Crewmember has attended several medical training sessions and learned more about medical care. Medics also increasing their medical lvl."
	skill_cap = 5
	skill_increment = 1
	skill = SKILL_MEDICAL
	cost = 2
