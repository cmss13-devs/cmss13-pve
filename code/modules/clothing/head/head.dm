...
/obj/item/clothing/head/cmcap
	...
	var/list/allowed_hat_items = list(
		...
		//GASMASK
		/obj/item/clothing/mask/gas/military = HAT_GARB_RELAY_ICON_STATE,
		/obj/item/clothing/mask/gas/military/upp = HAT_GARB_RELAY_ICON_STATE,

		// WALKMAN AND CASSETTES
		/obj/item/device/walkman = HAT_GARB_RELAY_ICON_STATE,
