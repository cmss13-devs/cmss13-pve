...
/obj/item/clothing/head/helmet/marine/tech/tanker/para
	...
	desc = "A heavily modified USCM helmet used by members of the USASF para-rescue units for it's compact design and adequate protection. A camera on the side and biometric transmitter ties into the sensor matrix."
	built_in_visors = list(new /obj/item/device/helmet_visor, new /obj/item/device/helmet_visor/medical/advanced)
	start_down_visor_type = /obj/item/device/helmet_visor/medical/advanced
	flags_atom = NO_SNOW_TYPE|NO_NAME_OVERRIDE
...
//No more lamarr jumping you the moment you open up the army helmet
GLOBAL_LIST_INIT(allowed_army_helmet_items, list(
	// TOBACCO-RELATED
	/obj/item/tool/lighter/random = HELMET_GARB_RELAY_ICON_STATE,
	/obj/item/tool/lighter/zippo = HELMET_GARB_RELAY_ICON_STATE,
	/obj/item/storage/box/matches = HELMET_GARB_RELAY_ICON_STATE,
	...
	/obj/item/tool/surgery/scalpel = "scalpel",
	/obj/item/reagent_container/hypospray/autoinjector = "helmet_injector",
	/obj/item/storage/pill_bottle/packet = "pills",
))
