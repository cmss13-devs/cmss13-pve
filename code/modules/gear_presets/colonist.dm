...
/datum/equipment_preset/colonist/spanish/load_name(mob/living/carbon/human/new_human, randomise)
	new_human.gender = pick(50;MALE,50;FEMALE)
	new_human.skin_color = pick(45;"Tan 3",10;"Tan 2",15;"Dark 1",10;"Dark 3",10;"Melanated",5;"Pale 3",5;"Pale 2")
	var/random_name = capitalize(pick(new_human.gender == MALE ? GLOB.first_names_male_spanish : GLOB.first_names_female_spanish)) + " " + capitalize(pick(GLOB.last_names_spanish))
...
/datum/equipment_preset/colonist/spanish/bluecollar
...
/datum/equipment_preset/colonist/spanish/bluecollar/get_assignment(mob/living/carbon/human/new_human)
	if(prob(50))
		return "Class D Inhabitant"

	return "Class C Inhabitant"

/datum/equipment_preset/colonist/spanish/bluecollar/load_gear(mob/living/carbon/human/new_human)
...
/datum/equipment_preset/colonist/spanish/miner
...
/datum/equipment_preset/colonist/spanish/miner/load_gear(mob/living/carbon/human/new_human)
	new_human.undershirt = "undershirt"
...
/datum/equipment_preset/colonist/spanish/construction
	name = "LatAm Civilian Colonist, Blue-Collar (Construction)"
	assignment = "Construction Worker"
	flags = EQUIPMENT_PRESET_EXTRA
	faction = FACTION_COLONIST
	paygrades = list(PAY_SHORT_CIV = JOB_PLAYTIME_TIER_0)
...
/datum/equipment_preset/colonist/spanish/construction/load_gear(mob/living/carbon/human/new_human)
...
/datum/equipment_preset/colonist/spanish/roughneck
	name = "LatAm Civilian Colonist, Blue-Collar (Roughneck)"
	flags = EQUIPMENT_PRESET_EXTRA
	faction = FACTION_COLONIST
	paygrades = list(PAY_SHORT_CIV = JOB_PLAYTIME_TIER_0)
	skills = /datum/skills/civilian
...
/datum/equipment_preset/colonist/spanish/roughneck/get_assignment(mob/living/carbon/human/new_human)
	if(prob(50))
		return "Driller"
	if(prob(50))
		return "Derrickhand"
...
/datum/equipment_preset/colonist/spanish/roughneck/load_gear(mob/living/carbon/human/new_human)
...
/datum/equipment_preset/colonist/spanish/cook
	name = "LatAm Civilian Colonist, Blue-Collar (Cook)"
	assignment = "Cook"
	flags = EQUIPMENT_PRESET_EXTRA
	faction = FACTION_COLONIST
	paygrades = list(PAY_SHORT_CIV = JOB_PLAYTIME_TIER_0)
...
/datum/equipment_preset/colonist/spanish/cook/load_gear(mob/living/carbon/human/new_human)
...
/datum/equipment_preset/colonist/spanish/chef
	name = "LatAm Civilian Colonist, Blue-Collar (Chef)"
	assignment = "Chef"
	flags = EQUIPMENT_PRESET_EXTRA
	faction = FACTION_COLONIST
	paygrades = list(PAY_SHORT_CIV = JOB_PLAYTIME_TIER_0)
...
/datum/equipment_preset/colonist/spanish/chef/load_gear(mob/living/carbon/human/new_human)
...
/datum/equipment_preset/colonist/spanish/priest
	name = "LatAm Civilian Colonist, Priest"
	assignment = "Spiritual Guidance Counselor"
	flags = EQUIPMENT_PRESET_EXTRA
	faction = FACTION_COLONIST
	paygrades = list(PAY_SHORT_CIV = JOB_PLAYTIME_TIER_0)
...
/datum/equipment_preset/colonist/spanish/priest/load_gear(mob/living/carbon/human/new_human)
...
/datum/equipment_preset/colonist/spanish/whitecollar
...
/datum/equipment_preset/colonist/spanish/whitecollar/get_assignment(mob/living/carbon/human/new_human)
	if(prob(50))
		return "Class B Inhabitant"

	return "Class A Inhabitant"

/datum/equipment_preset/colonist/spanish/whitecollar/load_gear(mob/living/carbon/human/new_human)
...
/datum/equipment_preset/colonist/spanish/whitecollar/exec
...
/datum/equipment_preset/colonist/spanish/whitecollar/exec/get_assignment(mob/living/carbon/human/new_human)
	if(prob(25))
		return "Senior Executive"

	return "Executive"

/datum/equipment_preset/colonist/spanish/whitecollar/exec/load_gear(mob/living/carbon/human/new_human)
...
/datum/equipment_preset/colonist/spanish/researcher
...
/datum/equipment_preset/colonist/spanish/researcher/load_gear(mob/living/carbon/human/new_human)
...
/datum/equipment_preset/colonist/spanish/doctor
...
/datum/equipment_preset/colonist/spanish/doctor/load_gear(mob/living/carbon/human/new_human)
...
/datum/equipment_preset/colonist/spanish/doctor/scrubs
	name = "LatAm Civilian Doctor, Scrubs"

/datum/equipment_preset/colonist/spanish/doctor/scrubs/load_gear(mob/living/carbon/human/new_human)
...
/datum/equipment_preset/colonist/spanish/admin
...
/datum/equipment_preset/colonist/spanish/admin/load_gear(mob/living/carbon/human/new_human)
...
/datum/equipment_preset/colonist/spanish/cargo
	name = "LatAm Civilian Logistics Worker"
	flags = EQUIPMENT_PRESET_EXTRA
	faction = FACTION_COLONIST
	assignment = "Logistical Technician"
	paygrades = list(PAY_SHORT_CIV = JOB_PLAYTIME_TIER_0)
...
/datum/equipment_preset/colonist/spanish/cargo/load_gear(mob/living/carbon/human/new_human)
...
/datum/equipment_preset/colonist/spanish/technician
...
/datum/equipment_preset/colonist/spanish/technician/load_gear(mob/living/carbon/human/new_human)
...
/datum/equipment_preset/colonist/spanish/engineer
...
/datum/equipment_preset/colonist/spanish/engineer/get_assignment(mob/living/carbon/human/new_human)
	if(prob(85))
		return "Engineer"
	return "Foreman"

/datum/equipment_preset/colonist/spanish/engineer/load_gear(mob/living/carbon/human/new_human)
	new_human.undershirt = "undershirt"
	//back
	new_human.equip_to_slot_or_del(new /obj/item/storage/backpack/marine/satchel(new_human), WEAR_BACK)
	//face
...
/datum/equipment_preset/colonist/spanish/operations
...
/datum/equipment_preset/colonist/spanish/operations/load_gear(mob/living/carbon/human/new_human)
...
/datum/equipment_preset/colonist/spanish/prisoner
	name = "LatAm Prisoner"
	flags = EQUIPMENT_PRESET_EXTRA
	faction = FACTION_COLONIST
	assignment = "Inmate"
...
/datum/equipment_preset/colonist/spanish/prisoner/load_gear(mob/living/carbon/human/new_human)
...
/datum/equipment_preset/colonist/spanish/security
...
/datum/equipment_preset/colonist/spanish/security/load_gear(mob/living/carbon/human/new_human)
...
/datum/equipment_preset/colonist/spanish/security/weyland
	name = "LatAm Civilian Security Guard, Wey-Yu"
	flags = EQUIPMENT_PRESET_EXTRA
	faction = FACTION_COLONIST
	faction_group = FACTION_LIST_WY_COLONY
	assignment = "Weyland-Yutani Corporate Security Officer"
...
/datum/equipment_preset/colonist/spanish/security/weyland/load_gear(mob/living/carbon/human/new_human)
...
/datum/equipment_preset/colonist/spanish/security/prison
	name = "LatAm Civilian Security Guard, Prison"
	flags = EQUIPMENT_PRESET_EXTRA
	faction = FACTION_COLONIST
	faction_group = FACTION_LIST_UA_COLONY
	assignment = "Corrections Officer"
...
/datum/equipment_preset/colonist/spanish/security/prison/load_gear(mob/living/carbon/human/new_human)
...
/datum/equipment_preset/colonist/spanish/security/guard
	name = "LatAm Civilian Security Guard, UA Colonial Guard"
	flags = EQUIPMENT_PRESET_EXTRA
	faction_group = FACTION_LIST_UA_COLONY
	assignment = "Colonial Militiaman"
	paygrades = list(PAY_SHORT_ME2 = JOB_PLAYTIME_TIER_0)
...
/datum/equipment_preset/colonist/spanish/security/guard/load_gear(mob/living/carbon/human/new_human)
...
/datum/equipment_preset/colonist/japanese/load_name(mob/living/carbon/human/new_human, randomise)
	new_human.gender = pick(50;MALE, 50;FEMALE)
...
/datum/equipment_preset/colonist/japanese/bluecollar
...
/datum/equipment_preset/colonist/japanese/bluecollar/get_assignment(mob/living/carbon/human/new_human)
	if(prob(50))
		return "Class D Inhabitant"

	return "Class C Inhabitant"

/datum/equipment_preset/colonist/japanese/bluecollar/load_gear(mob/living/carbon/human/new_human)
...
/datum/equipment_preset/colonist/japanese/miner
...
/datum/equipment_preset/colonist/japanese/miner/load_gear(mob/living/carbon/human/new_human)
	new_human.undershirt = "undershirt"
...
/datum/equipment_preset/colonist/japanese/cook/load_gear(mob/living/carbon/human/new_human)
...
/datum/equipment_preset/colonist/japanese/chef
	name = "TWE Civilian Colonist, Blue-Collar (Chef)"
	assignment = "Chef"
	flags = EQUIPMENT_PRESET_EXTRA
	faction = FACTION_COLONIST
	paygrades = list(PAY_SHORT_CIV = JOB_PLAYTIME_TIER_0)
...
/datum/equipment_preset/colonist/japanese/chef/load_gear(mob/living/carbon/human/new_human)
...
/datum/equipment_preset/colonist/japanese/priest
	name = "TWE Civilian Colonist, Priest"
	assignment = "Spiritual Guidance Counselor"
	flags = EQUIPMENT_PRESET_EXTRA
	faction = FACTION_COLONIST
	paygrades = list(PAY_SHORT_CIV = JOB_PLAYTIME_TIER_0)
...
/datum/equipment_preset/colonist/japanese/priest/load_gear(mob/living/carbon/human/new_human)
...
/datum/equipment_preset/colonist/japanese/whitecollar
...
/datum/equipment_preset/colonist/japanese/whitecollar/get_assignment(mob/living/carbon/human/new_human)
	if(prob(50))
		return "Class B Inhabitant"

	return "Class A Inhabitant"

/datum/equipment_preset/colonist/japanese/whitecollar/load_gear(mob/living/carbon/human/new_human)
...
/datum/equipment_preset/colonist/japanese/whitecollar/exec
...
/datum/equipment_preset/colonist/japanese/whitecollar/exec/get_assignment(mob/living/carbon/human/new_human)
	if(prob(25))
		return "Senior Executive"

	return "Executive"

/datum/equipment_preset/colonist/japanese/whitecollar/exec/load_gear(mob/living/carbon/human/new_human)
...
/datum/equipment_preset/colonist/japanese/researcher
...
/datum/equipment_preset/colonist/japanese/researcher/load_gear(mob/living/carbon/human/new_human)
...
/datum/equipment_preset/colonist/japanese/doctor
...
/datum/equipment_preset/colonist/japanese/doctor/load_gear(mob/living/carbon/human/new_human)
...
/datum/equipment_preset/colonist/japanese/doctor/scrubs
	name = "TWE Civilian Doctor, Scrubs"

/datum/equipment_preset/colonist/japanese/doctor/scrubs/load_gear(mob/living/carbon/human/new_human)
...
/datum/equipment_preset/colonist/japanese/admin
...
/datum/equipment_preset/colonist/japanese/admin/load_gear(mob/living/carbon/human/new_human)
...
/datum/equipment_preset/colonist/japanese/cargo
	name = "TWE Civilian Logistics Worker"
	flags = EQUIPMENT_PRESET_EXTRA
	faction = FACTION_COLONIST
	assignment = "Logistical Technician"
	paygrades = list(PAY_SHORT_CIV = JOB_PLAYTIME_TIER_0)
...
/datum/equipment_preset/colonist/japanese/cargo/load_gear(mob/living/carbon/human/new_human)
...
/datum/equipment_preset/colonist/japanese/technician
...
/datum/equipment_preset/colonist/japanese/technician/load_gear(mob/living/carbon/human/new_human)
...
/datum/equipment_preset/colonist/japanese/engineer
...
/datum/equipment_preset/colonist/japanese/engineer/get_assignment(mob/living/carbon/human/new_human)
	if(prob(85))
		return "Engineer"
	return "Foreman"

/datum/equipment_preset/colonist/japanese/engineer/load_gear(mob/living/carbon/human/new_human)
	new_human.undershirt = "undershirt"
	//back
	new_human.equip_to_slot_or_del(new /obj/item/storage/backpack/marine/satchel(new_human), WEAR_BACK)
	//face
...
/datum/equipment_preset/colonist/japanese/operations
...
/datum/equipment_preset/colonist/japanese/operations/load_gear(mob/living/carbon/human/new_human)
...
/datum/equipment_preset/colonist/japanese/prisoner
	name = "TWE Prisoner"
	flags = EQUIPMENT_PRESET_EXTRA
	faction = FACTION_COLONIST
	assignment = "Inmate"
...
/datum/equipment_preset/colonist/japanese/prisoner/load_gear(mob/living/carbon/human/new_human)
...
/datum/equipment_preset/colonist/japanese/security
	name = "TWE Civilian Security Guard, Generic"
	flags = EQUIPMENT_PRESET_EXTRA
	faction = FACTION_COLONIST
	assignment = "Security Officer"
	paygrades = list(PAY_SHORT_CPO = JOB_PLAYTIME_TIER_0)
...
/datum/equipment_preset/colonist/japanese/security/load_gear(mob/living/carbon/human/new_human)
...
/datum/equipment_preset/colonist/japanese/security/weyland
...
/datum/equipment_preset/colonist/japanese/security/weyland/load_gear(mob/living/carbon/human/new_human)
...
/datum/equipment_preset/colonist/japanese/security/trijent
...
/datum/equipment_preset/colonist/japanese/security/trijent/load_gear(mob/living/carbon/human/new_human)
