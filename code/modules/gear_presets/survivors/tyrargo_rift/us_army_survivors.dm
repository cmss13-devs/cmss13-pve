...
/datum/equipment_preset/survivor/army/proc/add_army_weapon(mob/living/carbon/human/new_human)
	...
	switch(random_gun)
		...
		if(9 , 10)
			...
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/rifle/m49a(new_human), WEAR_IN_BACK)
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/rifle/m49a(new_human), WEAR_IN_JACKET)
		if(11 , 12)
			new_human.equip_to_slot_or_del(new /obj/item/weapon/gun/rifle/m49a/army(new_human), WEAR_L_HAND)
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/rifle/m49a(new_human), WEAR_IN_BACK)
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/rifle/m49a(new_human), WEAR_IN_BACK)
...
/datum/equipment_preset/survivor/army/marksman/load_gear(mob/living/carbon/human/new_human)
	...
	spawn_pouch(new_human)
	new_human.equip_to_slot_or_del(new /obj/item/clothing/head/beret/cm/black/army(new_human), WEAR_HEAD)
	new_human.equip_to_slot_or_del(new /obj/item/weapon/gun/rifle/m49a/marksman(new_human), WEAR_L_HAND)
	new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/rifle/m49a(new_human), WEAR_IN_BACK)
	new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/rifle/m49a(new_human), WEAR_IN_BACK)
...
/datum/equipment_preset/survivor/army/gunner/load_gear(mob/living/carbon/human/new_human)
	...
	new_human.equip_to_slot_or_del(new /obj/item/weapon/gun/pistol/vp70(new_human), WEAR_IN_BELT)
...
/datum/equipment_preset/synth/survivor/army/load_gear(mob/living/carbon/human/preset_human)
	...
	preset_human.equip_to_slot_or_del(new /obj/item/clothing/glasses/sunglasses/big/orange(preset_human), WEAR_EYES)
