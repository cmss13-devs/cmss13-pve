...
/datum/equipment_preset/upp/police/mss/goon/load_gear(mob/living/carbon/human/new_human)
	...
	//uniform
	new_human.equip_to_slot_or_del(new /obj/item/clothing/under/marine/veteran/UPP/naval, WEAR_BODY)
	//jacket
	new_human.equip_to_slot_or_del(new /obj/item/clothing/suit/storage/jacket/marine/upp/naval, WEAR_JACKET)
	//limbs
	new_human.equip_to_slot_or_del(new /obj/item/clothing/shoes/marine/upp, WEAR_FEET)
	//pockets
	new_human.equip_to_slot_or_del(new /obj/item/storage/pouch/firstaid/full/alternate, WEAR_R_STORE)
...
/datum/equipment_preset/upp/police/mss/goon/armed
	name = "UPP MSS Goon (Armed - SMG)"

/datum/equipment_preset/upp/police/mss/goon/armed/load_gear(mob/living/carbon/human/new_human)
...
/datum/equipment_preset/upp/police/mss/goon/armed/shotgun
	name = "UPP MSS Goon (Armed - Shotgun)"

/datum/equipment_preset/upp/police/mss/goon/armed/shotgun/load_gear(mob/living/carbon/human/new_human)
...
/datum/equipment_preset/upp/police/mss/goon/armed/heavy
	name = "UPP MSS Goon (Armed - Heavy)"

/datum/equipment_preset/upp/police/mss/goon/armed/heavy/load_gear(mob/living/carbon/human/new_human)
