/datum/equipment_preset/uscm/event/dress
...
/datum/equipment_preset/uscm/event/dress/load_gear(mob/living/carbon/human/new_human)
...
/datum/equipment_preset/uscm/event/dress/lcpl
	name = "Dress Blues - (E-3) Lance Corporal"
	paygrades = list(PAY_SHORT_ME3 = JOB_PLAYTIME_TIER_0)

//NCOs/SNCOs//

/datum/equipment_preset/uscm/event/dress/nco
...
/datum/equipment_preset/uscm/event/dress/nco/load_gear(mob/living/carbon/human/new_human)
...
/datum/equipment_preset/uscm/event/dress/nco/sgt
	name = "Dress Blues - (E-5) Sergeant"
	paygrades = list(PAY_SHORT_ME5 = JOB_PLAYTIME_TIER_0)

/datum/equipment_preset/uscm/event/dress/nco/snco
...
/datum/equipment_preset/uscm/event/dress/officer/load_gear(mob/living/carbon/human/new_human)
	new_human.equip_to_slot_or_del(new /obj/item/clothing/under/marine/dress/blues/senior(new_human), WEAR_BODY)
...
/datum/equipment_preset/uscm/event/dress/officer/firstlt
	name = "Dress Blues - (O-2) 1st Lieutenant"
	paygrades = list(PAY_SHORT_MO2 = JOB_PLAYTIME_TIER_0)

/datum/equipment_preset/uscm/event/dress/officer/capt
...
/datum/equipment_preset/uscm/event/dress/officer/capt/New()

	access = get_access(ACCESS_LIST_MARINE_MAIN)

/datum/equipment_preset/uscm/event/dress/officer/co
	name = "Dress Blues - (O-4) Major"
	paygrades = list(PAY_SHORT_MO4 = JOB_PLAYTIME_TIER_0)
	idtype = /obj/item/card/id/gold
	skills = /datum/skills/commander

/datum/equipment_preset/uscm/event/dress/officer/co/New()

	access = get_access(ACCESS_LIST_MARINE_ALL)

/datum/equipment_preset/uscm/event/dress/officer/co/ltcol
...
/datum/equipment_preset/uscm/event/dress/officer/co/col
...
/datum/equipment_preset/uscm/event/dress/officer/general
...
/datum/equipment_preset/uscm/event/dress/officer/general/New()

	access = get_access(ACCESS_LIST_MARINE_ALL)

/datum/equipment_preset/uscm/event/dress/officer/general/load_gear(mob/living/carbon/human/new_human)
...
/datum/equipment_preset/uscm/event/dress/officer/general/ltgen
	name = "Dress Blues - (O-9) Lieutenant General"
	paygrades = list(PAY_SHORT_MO9 = JOB_PLAYTIME_TIER_0)

/datum/equipment_preset/uscm/event/dress/officer/general/gen
