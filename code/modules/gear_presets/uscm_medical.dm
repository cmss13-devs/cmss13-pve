/datum/equipment_preset/uscm_ship/uscm_medical
	...
	utility_under = list(/obj/item/clothing/under/medical/green)
	utility_hat = list()
	utility_gloves = list()
...
/datum/equipment_preset/uscm_ship/uscm_medical/cmo
	...
	utility_under = list(/obj/item/clothing/under/chief_medical_officer)
...
/datum/equipment_preset/uscm_ship/uscm_medical/cmo/load_gear(mob/living/carbon/human/new_human)
	...
	new_human.equip_to_slot_or_del(new /obj/item/clothing/under/chief_medical_officer(new_human), WEAR_BODY)
