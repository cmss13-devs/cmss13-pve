...
/datum/human_ai_equipment_preset/upp_eva
	faction = FACTION_UPP + " (EVA)"

/datum/human_ai_equipment_preset/upp_eva/rifleman_eva
...
/datum/human_ai_equipment_preset/upp_eva/rifleman_eva_type71
	name = "EVA UPP Squad Rifleman (Type 71)"
	desc = "The standard UPP soldier armed with a Type 71. Has less falloff and more damage and AP than the AG 80. Sometimes wears a toolbelt."
	path = /datum/equipment_preset/upp/rifleman/eva_type71

/datum/human_ai_equipment_preset/upp_eva/rifleman_eva_sniper
...
/datum/human_ai_equipment_preset/upp_eva/shotgun_eva
...
/datum/human_ai_equipment_preset/upp_eva/machinegunner_eva
	name = "EVA UPP Squad Machinegunner"
	desc = "The UPP’s answer to the USCM’s smartgunner. About as strong, can gun down unaware marines easily."
	path = /datum/equipment_preset/upp/machinegunner/eva

/datum/human_ai_equipment_preset/upp_eva/flamethrower_eva
...
/datum/human_ai_equipment_preset/upp_eva/eva_rocket
	name = "EVA UPP Squad Rocketeer"
	desc = "Carries a UPP rocket launcher loaded with a single AP rocket, and a sidearm. Will reduce enemies to pieces."
...
/datum/human_ai_equipment_preset/upp_eva/medic_eva
	name = "EVA UPP Squad Sanitar"
	desc = "The guy who tries to keep the rest of the team alive. Comes equipped with medical supplies, though they don’t always live long enough to do treatment."
	path = /datum/equipment_preset/upp/sanitar/eva

/datum/human_ai_equipment_preset/upp_eva/sergeant
