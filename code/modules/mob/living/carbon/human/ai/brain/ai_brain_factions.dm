...
/datum/human_ai_faction/traitors
	...
	enter_combat_lines = list(
		...
		"YOU FUCKIN' COWARDS!",
		"YOU FUCKIN' JACKBOOTS!",
		"YOU FUCKIN' LOYALISTS!",
		"YOU FUCKIN' LACKEYS!",
		"GLORY TO CHAOS!",
		"EAT THIS!",
		"LET THE BLOOD FLOW!",
		"GET 'EM!",
		"DOWN WITH THESE IMPERIAL DOGS!",
		"HAHAHAHAHA!",
	)
	exit_combat_lines = list(
		"CEASE FIRE!",
		...
		"I need a break...",
		"Need a fuckin' smoke after that...",
		"Need a fuckin' lho-stick after that...",
		"Need a fuckin' shot after that...",
		"Situation normal; all fucked up...",
		"This, is fucking FUBAR, man...",
		"Never gets easier...",
...
/datum/human_ai_faction/kasrkin
	faction = FACTION_KASRKIN
	friendly_factions = list(
		FACTION_COLONIST,
		FACTION_IMPERIAL_GUARD,
	)
	neutral_factions = list(
		FACTION_SURVIVOR,
	)
