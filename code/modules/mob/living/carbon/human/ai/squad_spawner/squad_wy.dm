...
/datum/human_ai_squad_preset/wy/squad
	...
	desc = "A squad comprised of 2 corporate tactical response officers armed with M39s, 1 corporate heavy response officer armed with an AP M39 and 1 corporate tactical response officer armed with a HG-37 loaded with slugs."
	ai_to_spawn = list(
		/datum/equipment_preset/colonist/security/weyland/tactical = 2,
		/datum/equipment_preset/colonist/security/weyland/tactical/heavy = 1,
