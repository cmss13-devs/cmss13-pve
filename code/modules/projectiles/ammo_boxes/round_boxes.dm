...
//----------------11.7x22mm Ammunition Boxes (for UPP Type71 family)------------------

/obj/item/ammo_box/rounds/type71
	name = "\improper rifle ammunition box (11.7x22mm)"
	desc = "A 11.7x22mm ammunition box. Used to refill Type71 magazines. It comes with a leather strap allowing to wear it on the back."
...
/obj/item/ammo_box/rounds/type71/ap
	name = "\improper rifle ammunition box (11.7x22mm AP)"
	desc = "A 11.7x22mm armor-piercing ammunition box. Used to refill Type71 AP magazines. It comes with a leather strap allowing to wear it on the back."
	icon_state = "base_type71"
	overlay_gun_type = "_rounds_type71"
...
/obj/item/ammo_box/rounds/type71/heap
	name = "rifle ammunition box (11.7x22mm HEAP)"
	desc = "A 11.7x22mm high-explosive armor-piercing ammunition box. Used to refill Type 71 and QYJ-72 HEAP magazines. It comes with a leather strap allowing to wear it on the back."
	icon_state = "base_type71"
	overlay_gun_type = "_rounds_type71"
...
/obj/item/ammo_box/rounds/pkp
	name = "large rifle ammunition box (11.7x22mm)"
	desc = "A 11.7x22mm machinegun ammunition box. Used to mostly to refill Type 71 and QYJ-72 box magazines. It comes with a leather strap allowing to wear it on the back."
	icon_state = "base_type71"
