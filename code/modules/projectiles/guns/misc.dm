...
/obj/item/weapon/gun/pkp
	...
	desc = "The QYJ-72 is the standard GPMG of the Union of Progressive Peoples, chambered in 11.7x22mm, it fires a hard-hitting round with a high rate of fire. With an extremely large box at 250 rounds, the QJY-72 is designed with suppressing fire and accuracy by volume of fire at its forefront. \n<b>Alt-click it to open the feed cover and allow for reloading.</b>"
