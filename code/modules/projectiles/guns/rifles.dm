...
/obj/item/weapon/gun/rifle/m4ra/pve
	...
	desc_lore = "The USCM was not terribly enthusiastic about unproven hand-held plasma weaponry. Before the XM99A was eventually adopted into use, the USMC instead sought out a traditional squad-portable, precision, armor-piercing weapon, and contracted ARMAT to upgrade their M4RA platform to be capable of firing advanced AP rounds. They succeeded- sort of. /n /n  The R2 was rejected for a several reasons. It's a killer, but also a piece of junk. It kicks hard enough that precision sights simply don't stay zeroed, its oversized muzzle-barrel extends an already long barrel-length, and A19 ammo, already expensive, was driven to absurd highs by the ammunition's specs. Depleted uranium is expensive...but cutting the service life of the M4RA's barrel in half is even more expensive."
