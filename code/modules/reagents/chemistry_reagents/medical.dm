...
/datum/reagent/medical/adrenaline_concentrated
	...
	chemclass = CHEM_CLASS_COMMON
	properties = list(PROPERTY_PAINKILLING = 1.5, PROPERTY_ELECTROGENETIC = 4, PROPERTY_OXYGENATING = 2, PROPERTY_REVITALIZING = 1, PROPERTY_INTRAVENOUS = 1, PROPERTY_CARDIOTOXIC = 3)
	flags = REAGENT_TYPE_MEDICAL | REAGENT_SCANNABLE
