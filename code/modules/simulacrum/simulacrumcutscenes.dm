...
/proc/simulacrum_text_ending_bad(mob/living/carbon/human/human)
	...
	text_box.text_to_play = "REPORT LOGGED TO HIGH COMMAND: USS ROVER MISSING, CONSIDERED LOST WITH ALL HANDS. LAST MESSAGE RECIEVED FROM 16-CYGNI SYSTEM, CONTAINS UNKNOWN ELECTROMAGNETIC INTERFERENCE."
	...
	body.text_to_play = "WARNING. WARNING. 'UMBRELLA' SOL DETECTION ARRAYS REPORT UNIDENTIFIED OBJECT EMERGING FROM SHUNT IN OORT CLOUD PROXIMITY"
