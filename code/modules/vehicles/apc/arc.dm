...
/obj/vehicle/multitile/apc/arc
	...
	desc = "An M540 Armored Recon Carrier, also known as an ARC. This is a much lighter and more nimble version of the M557A3 APC, often preferred by recon forces for that very reason. Entrance on the right."
