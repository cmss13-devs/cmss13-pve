/obj/item/hardpoint/primary/arc_frontalcannon
	...
	desc = "A preculiar turret with two rotary cannons strapped to the front of it. Normally equipped with an autonomous mode, this one curiously lacks the feature."
