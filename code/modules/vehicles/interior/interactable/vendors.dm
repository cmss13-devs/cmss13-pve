...
/obj/structure/machinery/cm_vending/sorted/vehicle_supply/populate_product_list(scale)
	listed_products = list(
		...
		list("M4A3 Magazine (9x19mm)", floor(scale * 10), /obj/item/ammo_magazine/pistol, VENDOR_ITEM_REGULAR),
		list("VP70 Magazine (9x19mm)", floor(scale * 8), /obj/item/ammo_magazine/pistol/vp70, VENDOR_ITEM_REGULAR),
		...
		list("M4A3 AP Magazine (9x19mm)", 0, /obj/item/ammo_magazine/pistol/ap, VENDOR_ITEM_REGULAR),
		...
		list("M4A3 HP Magazine (9x19mm)", 0, /obj/item/ammo_magazine/pistol/hp, VENDOR_ITEM_REGULAR),
...
/obj/structure/machinery/cm_vending/sorted/vehicle_supply/tent/populate_product_list(scale)
	listed_products = list(
		...
		list("M4A3 Magazine (9x19mm)", 0, /obj/item/ammo_magazine/pistol, VENDOR_ITEM_REGULAR),
		list("M56D Drum Magazine", 0, /obj/item/ammo_magazine/m56d, VENDOR_ITEM_REGULAR),
		list("M2C Box Magazine", 0, /obj/item/ammo_magazine/m2c, VENDOR_ITEM_REGULAR),
