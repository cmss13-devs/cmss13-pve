...
/obj/effect/vehicle_spawner/tank/ridgeway
	name = "Tank Spawner"
	icon = 'icons/obj/vehicles/ridgeway.dmi'
	icon_state = "tank_base"
	pixel_x = -48
...
/obj/effect/vehicle_spawner/tank/ridgeway/Initialize()
	. = ..()
	spawn_vehicle()
	qdel(src)

//PRESET: turret, no hardpoints (not the one without turret for convenience, you still expect to have turret when you spawn "no hardpoints tank")
/obj/effect/vehicle_spawner/tank/ridgeway/spawn_vehicle()
...
/obj/effect/vehicle_spawner/tank/ridgeway/load_hardpoints(obj/vehicle/multitile/tank/ridgeway/vic)
	vic.add_hardpoint(new /obj/item/hardpoint/holder/tank_turret/ridgeway)

//PRESET: turret, treads installed
/obj/effect/vehicle_spawner/tank/ridgeway/plain/load_hardpoints(obj/vehicle/multitile/tank/ridgeway/vic)
	vic.add_hardpoint(new /obj/item/hardpoint/holder/tank_turret/ridgeway)
	vic.add_hardpoint(new /obj/item/hardpoint/locomotion/treads)

//PRESET: no hardpoints
/obj/effect/vehicle_spawner/tank/ridgeway/hull/load_hardpoints(obj/vehicle/multitile/tank/ridgeway/vic)
	return

//Just the hull and it's broken TOO, you get the full experience
/obj/effect/vehicle_spawner/tank/ridgeway/hull/broken/spawn_vehicle()
	var/obj/vehicle/multitile/tank/ridgeway/tonk = ..()
	load_damage(tonk)
	tonk.update_icon()

//PRESET: default hardpoints, destroyed
/obj/effect/vehicle_spawner/tank/ridgeway/decrepit/spawn_vehicle()
	var/obj/vehicle/multitile/tank/ridgeway/TANK = new (loc)
...
/obj/effect/vehicle_spawner/tank/ridgeway/decrepit/load_hardpoints(obj/vehicle/multitile/tank/ridgeway/vic)
	vic.add_hardpoint(new /obj/item/hardpoint/support/weapons_sensor)
...
//PRESET: default hardpoints
/obj/effect/vehicle_spawner/tank/ridgeway/fixed/load_hardpoints(obj/vehicle/multitile/tank/ridgeway/vic)
	vic.add_hardpoint(new /obj/item/hardpoint/support/weapons_sensor)
	vic.add_hardpoint(new /obj/item/hardpoint/locomotion/treads/ridgeway)
	vic.add_hardpoint(new /obj/item/hardpoint/holder/tank_turret/ridgeway)
	for(var/obj/item/hardpoint/holder/tank_turret/ridgeway/tonkturret in vic.hardpoints)
...
/obj/effect/vehicle_spawner/tank/ridgeway/plasma/load_hardpoints(obj/vehicle/multitile/tank/ridgeway/vic)
	vic.add_hardpoint(new /obj/item/hardpoint/support/artillery_module)
	vic.add_hardpoint(new /obj/item/hardpoint/locomotion/treads/ridgeway)
	vic.add_hardpoint(new /obj/item/hardpoint/holder/tank_turret/ridgeway)
	for(var/obj/item/hardpoint/holder/tank_turret/ridgeway/tonkturret in vic.hardpoints)
