...
var/list/first_names_male_operator = list("Alpha", "Bravo", "Charlie", "Delta", "Echo", "Foxtrot", "Golf", "Hotel", "India", "Juliett", "Kilo", "Lima", "Mike", "November", "Oscar", "Papa", "Quebec", "Romeo", "Sierra", "Tango", "Uniform", "Victor", "Whiskey", "Xray", "Yankee", "Zulu", "Bravost", "Element", "Unit", "Hunter", "Outlaw", "Kronos", "Oni", "Kappa", "Noble", "One", "Two", "Three", "Four", "Five", "Six", "Seven", "Eight", "Nine", "Ten")
var/list/first_names_female_operator = list("Alpha", "Bravo", "Charlie", "Delta", "Echo", "Foxtrot", "Golf", "Hotel", "India", "Juliett", "Kilo", "Lima", "Mike", "November", "Oscar", "Papa", "Quebec", "Romeo", "Sierra", "Tango", "Uniform", "Victor", "Whiskey", "Xray", "Yankee", "Zulu", "Bravost", "Element", "Unit", "Hunter", "Outlaw", "Kronos", "Oni", "Kappa", "Noble", "One", "Two", "Three", "Four", "Five", "Six", "Seven", "Eight", "Nine", "Ten")
var/list/last_names_operator = list("Amaranth", "Amber", "Apricot", "Brown", "Blue", "Bronze", "Cerulean", "Crimson", "Charcoal", "Cyan", "Emerald", "Fuchsia", "Gold", "Gray", "Green", "Indigo", "Ivory", "Jade", "Lavender", "Lemon", "Lilac", "Magenta", "Maroon", "Navy", "Olive", "Orange", "Pink", "Purple", "Quartz", "Red", "Silver", "Tan", "Teal", "Ultramarine", "Violet", "White", "Yellow")
