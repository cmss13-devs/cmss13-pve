/obj/item/storage/box/spec/B18/outpost
	...
	desc = "A large case containing experimental weaponary and the B18 armor platform, designed to minimize battlefield injury. The B18 system is unlikely to leave field testing due to budget cuts even though it is reported to be highly effective. \nDrag this sprite onto yourself to open it up! NOTE: You cannot put items back inside this case."
	kit_overlay = "b18"
